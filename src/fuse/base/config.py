...
class AugmentedConfig(AutoConfig):
    ...
    def __init__(self, embedding_augmentation_type=False, aug_vocab_size=0, aug_token_bias=0, *args, **kwargs):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path, embedding_augmentation_type=False, aug_vocab_size=0, aug_token_bias=0, **kwargs):
